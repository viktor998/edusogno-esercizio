...
<body>
    <header class="my-3">
        <div>
            <h1 class="text-center">Aggiungi</h1>
        </div>
    </header>
    <main class="my-3">
        <div class="container">
            <form class="my-3" action="store.php" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nome_evento" required name="nome_evento">
                </div>
                <div class="mb-3">
                    <label for="data_evento" class="form-label">Data evento</label>
                    <input type="datetime-local" class="form-control" id="data_evento" required name="data_evento">
                </div>
