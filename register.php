...
<body>
    ...
    <main class="pt-4">
        <div class="main-container">
            <h2 class="title pb-2">Crea il tuo account</h2>
            <div class="container text-dark bg-lighter">
                <!--logica x alert -->
                <form action="sign-up.php" method="post">
                    <div class="my-3 input-container">
                        <label for="nome" class="input-label">Inserisci il nome</label>
                        <input type="text" class="form-input" id="nome" name="nome" placeholder="Mario">
                    </div>
                    <div class="my-3 input-container">
                        <label for="cognome" class="input-label">Inserisci il cognome</label>
                        <input type="text" class="form-input" id="cognome" name="cognome" placeholder="Rossi">
                    </div>
                ...
                <div class="text-center">
                    <a href="index.php" class="bottom-link">Hai già un account? <strong>Accedi</strong></a>
                </div>
            </div>
        </div>
